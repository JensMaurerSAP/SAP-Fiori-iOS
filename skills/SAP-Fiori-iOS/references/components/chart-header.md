...
- **Title** — `.headline`, `.primaryLabel`, single line
- **Subtitle** — `.footnote`, `.tertiaryLabel`, single line
- **Trend** — `.subheadline`, `.tertiaryLabel`, single line
- **TrendImage** — `.caption1`, `.tertiaryLabel`, single line
- **Chart** — fixed height of 75 pt
